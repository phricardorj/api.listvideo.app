...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
        ...
        return ResponseEntity.status(CONFLICT).body(new ErrorResponse(
                CONFLICT.value(),
                message,
    ...
    public record ErrorResponse(LocalDateTime date, int httpStatusCode, Object message, String errorCode) {
